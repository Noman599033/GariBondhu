...
// Clear existing migrations for a clean slate
...
$migrations = [
    '2026_01_01_000001_create_users_table.php' => <<<EOT
<?php
...
EOT,
    ...
    '2026_01_01_000002_create_admins_table.php' => <<<EOT
<?php
use Illuminate\Database\Migrations\Migration;
use Illuminate\Database\Schema\Blueprint;
use Illuminate\Support\Facades\Schema;
...
EOT,
    ...
    '2026_01_01_000003_create_fleet_tables.php' => <<<EOT
<?php
use Illuminate\Database\Migrations\Migration;
use Illuminate\Database\Schema\Blueprint;
use Illuminate\Support\Facades\Schema;
...
EOT,
    ...
    '2026_01_01_000004_create_location_tables.php' => <<<EOT
<?php
use Illuminate\Database\Migrations\Migration;
use Illuminate\Database\Schema\Blueprint;
use Illuminate\Support\Facades\Schema;
...
EOT,
    ...
    '2026_01_01_000005_create_booking_tables.php' => <<<EOT
<?php
use Illuminate\Database\Migrations\Migration;
use Illuminate\Database\Schema\Blueprint;
use Illuminate\Support\Facades\Schema;
...
EOT,
    ...
    '2026_01_01_000006_create_payments_and_inspections.php' => <<<EOT
<?php
use Illuminate\Database\Migrations\Migration;
use Illuminate\Database\Schema\Blueprint;
use Illuminate\Support\Facades\Schema;
...
echo "Migrations successfully generated.";
